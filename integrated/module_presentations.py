     ...
     [(set_fixed_point_multiplier, 1000),
      ...
      (else_try),
        ...
        (try_for_range, ":cur_template", multiplayer_coop_class_templates_begin, multiplayer_coop_class_templates_end),
          (store_troop_faction, ":trp.faction", ":cur_template"),
          (eq, ":trp.faction", ":my_faction_no"),
          (store_character_level, ":trp.level", ":cur_template"),
          (eq, ":trp.level", 4),
   ...
   [
     ...
     (ti_on_presentation_event_state_change,
      [
        ...
        (call_script, "script_get_troop_custom_banner_num_positionings", "trp_player"),
        (assign, ":num_positionings", reg0),
        (try_for_range, ":trp.slot_index", 0, ":num_positionings"),
          (troop_slot_eq, "trp_temp_array_a", ":trp.slot_index", ":object"),
          (troop_set_slot, "trp_player", slot_troop_custom_banner_positioning, ":trp.slot_index"),
   ...
   [
     ...
     (ti_on_presentation_event_state_change,
      [
        ...
        (try_for_range, ":trp.slot_index", 0, ":end_cond"),
          (troop_slot_eq, "trp_temp_array_a", ":trp.slot_index", ":object"),
          (troop_set_slot, "trp_player", "$g_presentation_output_slot", ":trp.slot_index"),
          (assign, ":end_cond", 0),
        (try_end),
        (try_begin),
          (gt, "$g_presentation_next_presentation", 0),
   ...
   [
     ...
     (ti_on_presentation_event_state_change,
      [
        ...
        (try_for_range, ":trp.slot_index", 0, ":end_cond"),
          (troop_slot_eq, "trp_temp_array_a", ":trp.slot_index", ":object"),
          (troop_set_slot, "trp_player", slot_troop_custom_banner_bg_type, ":trp.slot_index"),
          (assign, ":end_cond", 0),
        (try_end),
        (try_begin),
          (gt, "$g_presentation_next_presentation", 0),
   ...
   [
     ...
     (ti_on_presentation_event_state_change,
      [
        ...
        (try_for_range, ":trp.slot_index", 0, ":end_cond"),
          (troop_slot_eq, "trp_temp_array_a", ":trp.slot_index", ":object"),
          (troop_set_slot, "trp_player", slot_troop_custom_banner_flag_type, ":trp.slot_index"),
          (assign, ":end_cond", 0),
        (try_end),
        (try_begin),
          (gt, "$g_presentation_next_presentation", 0),
   ...
   [
     ...
     (ti_on_presentation_event_state_change,
      [
        ...
        (try_for_range, ":trp.slot_index", 0, ":end_cond"),
          (troop_slot_eq, "trp_temp_array_a", ":trp.slot_index", ":object"),
          (troop_set_slot, "trp_player", slot_troop_custom_banner_map_flag_type, ":trp.slot_index"),
          (assign, ":end_cond", 0),
        (try_end),
        (try_begin),
          (gt, "$g_presentation_next_presentation", 0),
     ...
     (ti_on_presentation_load,
      [
        ...
        (try_for_range, ":i_color", 0, 42),
          ...
          (position_set_y, pos1, 500),
          (overlay_set_size, reg1, pos1),
          (store_mul, ":trp.slot_index", ":i_color", 2),
          (store_add, ":trp.slot_color", ":trp.slot_index", 1),
          (troop_set_slot, "trp_temp_array_a", ":trp.slot_index", reg1),
          (troop_set_slot, "trp_temp_array_a", ":trp.slot_color", ":cur_color"),
        (try_end),
        (presentation_set_duration, 999999),
        ]),
     (ti_on_presentation_event_state_change,
      [
        ...
        (try_for_range, ":i_color", 0, ":end_cond"),
          ...
          (troop_slot_eq, "trp_temp_array_a", ":trp.slot_index", ":object"),
          (store_add, ":trp.slot_color", ":trp.slot_index", 1),
          (troop_get_slot, ":output_color", "trp_temp_array_a", ":trp.slot_color"),
