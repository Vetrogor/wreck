...
##       (try_begin),
##         (gt, "$qst.defend_nobles_against_peasants_noble_party_1", 0),
##         (party_is_active, "$qst.defend_nobles_against_peasants_noble_party_1"),
##         (val_add, ":num_active_parties", 1),
##         (party_is_in_town, "$qst.defend_nobles_against_peasants_noble_party_1", ":quest_target_center"),
##         (remove_party, "$qst.defend_nobles_against_peasants_noble_party_1"),
##         (party_get_num_companions, ":num_companions", "$qst.defend_nobles_against_peasants_noble_party_1"),
##         (val_add, "$qst.defend_nobles_against_peasants_num_nobles_saved", ":num_companions"),
##       (try_end),
##       (try_begin),
##         (gt, "$qst.defend_nobles_against_peasants_noble_party_2", 0),
##         (party_is_active, "$qst.defend_nobles_against_peasants_noble_party_2"),
##         (val_add, ":num_active_parties", 1),
##         (party_is_in_town, "$qst.defend_nobles_against_peasants_noble_party_2", ":quest_target_center"),
##         (remove_party, "$qst.defend_nobles_against_peasants_noble_party_2"),
##         (party_get_num_companions, ":num_companions", "$qst.defend_nobles_against_peasants_noble_party_2"),
##         (val_add, "$qst.defend_nobles_against_peasants_num_nobles_saved", ":num_companions"),
##       (try_end),
##       (try_begin),
##         (gt, "$qst.defend_nobles_against_peasants_noble_party_3", 0),
##         (party_is_active, "$qst.defend_nobles_against_peasants_noble_party_3"),
##         (val_add, ":num_active_parties", 1),
##         (party_is_in_town, "$qst.defend_nobles_against_peasants_noble_party_3", ":quest_target_center"),
##         (remove_party, "$qst.defend_nobles_against_peasants_noble_party_3"),
##         (party_get_num_companions, ":num_companions", "$qst.defend_nobles_against_peasants_noble_party_3"),
##         (val_add, "$qst.defend_nobles_against_peasants_num_nobles_saved", ":num_companions"),
##       (try_end),
##       (try_begin),
##         (gt, "$qst.defend_nobles_against_peasants_noble_party_4", 0),
##         (party_is_active, "$qst.defend_nobles_against_peasants_noble_party_4"),
##         (val_add, ":num_active_parties", 1),
##         (party_is_in_town, "$qst.defend_nobles_against_peasants_noble_party_4", ":quest_target_center"),
##         (remove_party, "$qst.defend_nobles_against_peasants_noble_party_4"),
##         (party_get_num_companions, ":num_companions", "$qst.defend_nobles_against_peasants_noble_party_4"),
##         (val_add, "$qst.defend_nobles_against_peasants_num_nobles_saved", ":num_companions"),
##       (try_end),
##       (try_begin),
##         (gt, "$qst.defend_nobles_against_peasants_noble_party_5", 0),
##         (party_is_active, "$qst.defend_nobles_against_peasants_noble_party_5"),
##         (val_add, ":num_active_parties", 1),
##         (party_is_in_town, "$qst.defend_nobles_against_peasants_noble_party_5", ":quest_target_center"),
##         (remove_party, "$qst.defend_nobles_against_peasants_noble_party_5"),
##         (party_get_num_companions, ":num_companions", "$qst.defend_nobles_against_peasants_noble_party_5"),
##         (val_add, "$qst.defend_nobles_against_peasants_num_nobles_saved", ":num_companions"),
##       (try_end),
##       (try_begin),
##         (gt, "$qst.defend_nobles_against_peasants_noble_party_6", 0),
##         (party_is_active, "$qst.defend_nobles_against_peasants_noble_party_6"),
##         (val_add, ":num_active_parties", 1),
##         (party_is_in_town, "$qst.defend_nobles_against_peasants_noble_party_6", ":quest_target_center"),
##         (remove_party, "$qst.defend_nobles_against_peasants_noble_party_6"),
##         (party_get_num_companions, ":num_companions", "$qst.defend_nobles_against_peasants_noble_party_6"),
##         (val_add, "$qst.defend_nobles_against_peasants_num_nobles_saved", ":num_companions"),
##       (try_end),
##       (try_begin),
##         (gt, "$qst.defend_nobles_against_peasants_noble_party_7", 0),
##         (party_is_active, "$qst.defend_nobles_against_peasants_noble_party_7"),
##         (val_add, ":num_active_parties", 1),
##         (party_is_in_town, "$qst.defend_nobles_against_peasants_noble_party_7", ":quest_target_center"),
##         (remove_party, "$qst.defend_nobles_against_peasants_noble_party_7"),
##         (party_get_num_companions, ":num_companions", "$qst.defend_nobles_against_peasants_noble_party_7"),
##         (val_add, "$qst.defend_nobles_against_peasants_num_nobles_saved", ":num_companions"),
##       (try_end),
##       (try_begin),
##         (gt, "$qst.defend_nobles_against_peasants_noble_party_8", 0),
##         (party_is_active, "$qst.defend_nobles_against_peasants_noble_party_8"),
##         (val_add, ":num_active_parties", 1),
##         (party_is_in_town, "$qst.defend_nobles_against_peasants_noble_party_8", ":quest_target_center"),
##         (remove_party, "$qst.defend_nobles_against_peasants_noble_party_8"),
##         (party_get_num_companions, ":num_companions", "$qst.defend_nobles_against_peasants_noble_party_8"),
##         (val_add, "$qst.defend_nobles_against_peasants_num_nobles_saved", ":num_companions"),
##       (try_end),
##       (eq, ":num_active_parties", 0),
##       (try_begin),
##         (store_div, ":limit", "$qst.defend_nobles_against_peasants_num_nobles_to_save", 2),
##         (ge, "$qst.defend_nobles_against_peasants_num_nobles_saved", ":limit"),
...
##       (try_begin),
##         (gt, "$qst.capture_conspirators_num_parties_to_spawn", "$qst.capture_conspirators_num_parties_spawned"),
##         (store_random_in_range, ":random_no", 0, 100),
##         (lt, ":random_no", 20),
##         (set_spawn_radius, 3),
##         (spawn_around_party,":quest_target_center","pt_conspirator"),
##         (val_add, "$qst.capture_conspirators_num_parties_spawned", 1),
##         (party_get_num_companions, ":num_companions", reg0),
##         (val_add, "$qst.capture_conspirators_num_troops_to_capture", ":num_companions"),
##         (party_set_ai_behavior, reg0, ai_bhvr_travel_to_party),
##         (party_set_ai_object, reg0, "$qst.capture_conspirators_party_1"),
##         (party_set_flags, reg0, pf_default_behavior, 0),
##         (try_begin),
##           (le, "$qst.capture_conspirators_party_2", 0),
##           (assign, "$qst.capture_conspirators_party_2", reg0),
##         (else_try),
##           (le, "$qst.capture_conspirators_party_3", 0),
##           (assign, "$qst.capture_conspirators_party_3", reg0),
##         (else_try),
##           (le, "$qst.capture_conspirators_party_4", 0),
##           (assign, "$qst.capture_conspirators_party_4", reg0),
##         (else_try),
##           (le, "$qst.capture_conspirators_party_5", 0),
##           (assign, "$qst.capture_conspirators_party_5", reg0),
##         (else_try),
##           (le, "$qst.capture_conspirators_party_6", 0),
##           (assign, "$qst.capture_conspirators_party_6", reg0),
##         (else_try),
##           (le, "$qst.capture_conspirators_party_7", 0),
##           (assign, "$qst.capture_conspirators_party_7", reg0),
##         (try_end),
##       (try_end),
##
##       (assign, ":num_active_parties", 0),
##
##       (try_begin),
##         (gt, "$qst.capture_conspirators_party_1", 0),
##         (party_is_active, "$qst.capture_conspirators_party_1"),
##         (val_add, ":num_active_parties", 1),
##         (try_begin),
##           (party_is_in_any_town, "$qst.capture_conspirators_party_1"),
##           (remove_party, "$qst.capture_conspirators_party_1"),
##         (else_try),
##           (party_get_num_attached_parties, ":num_attachments", "$qst.capture_conspirators_party_1"),
##           (gt, ":num_attachments", 0),
##           (assign, ":leave_meeting", 0),
##           (try_begin),
##             (store_sub, ":required_attachments", "$qst.capture_conspirators_num_parties_to_spawn", 1),
##             (eq, ":num_attachments", ":required_attachments"),
##             (val_add, "$qst.capture_conspirators_leave_meeting_counter", 1),
##             (ge, "$qst.capture_conspirators_leave_meeting_counter", 15),
##             (assign, ":leave_meeting", 1),
##           (try_end),
##           (try_begin),
##             (eq, "$qst.capture_conspirators_num_parties_to_spawn", "$qst.capture_conspirators_num_parties_spawned"),
##             (store_distance_to_party_from_party, ":cur_distance", "p_main_party", "$qst.capture_conspirators_party_1"),
...
##             (assign, "$qst.capture_conspirators_leave_meeting_counter", 15),
##             (assign, ":leave_meeting", 1),
##           (try_end),
##           (eq, ":leave_meeting", 1),
##           (party_set_ai_behavior, "$qst.capture_conspirators_party_1", ai_bhvr_travel_to_point),
##           (party_set_flags, "$qst.capture_conspirators_party_1", pf_default_behavior, 0),
##           (party_get_position, pos1, "$qst.capture_conspirators_party_1"),
##           (call_script, "script_map_get_random_position_around_position_within_range", 15, 17),
##           (party_set_ai_target_position, "$qst.capture_conspirators_party_1", pos2),
##           (try_begin),
##             (gt, "$qst.capture_conspirators_party_2", 0),
##             (party_detach, "$qst.capture_conspirators_party_2"),
##             (party_set_ai_behavior, "$qst.capture_conspirators_party_2", ai_bhvr_travel_to_point),
##             (party_set_flags, "$qst.capture_conspirators_party_2", pf_default_behavior, 0),
##             (call_script, "script_map_get_random_position_around_position_within_range", 15, 17),
##             (party_set_ai_target_position, "$qst.capture_conspirators_party_2", pos2),
##           (try_end),
##           (try_begin),
##             (gt, "$qst.capture_conspirators_party_3", 0),
##             (party_detach, "$qst.capture_conspirators_party_3"),
##             (party_set_ai_behavior, "$qst.capture_conspirators_party_3", ai_bhvr_travel_to_point),
##             (party_set_flags, "$qst.capture_conspirators_party_3", pf_default_behavior, 0),
##             (call_script, "script_map_get_random_position_around_position_within_range", 15, 17),
##             (party_set_ai_target_position, "$qst.capture_conspirators_party_3", pos2),
##           (try_end),
##           (try_begin),
##             (gt, "$qst.capture_conspirators_party_4", 0),
##             (party_detach, "$qst.capture_conspirators_party_4"),
##             (party_set_ai_behavior, "$qst.capture_conspirators_party_4", ai_bhvr_travel_to_point),
##             (party_set_flags, "$qst.capture_conspirators_party_4", pf_default_behavior, 0),
##             (call_script, "script_map_get_random_position_around_position_within_range", 15, 17),
##             (party_set_ai_target_position, "$qst.capture_conspirators_party_4", pos2),
##           (try_end),
##           (try_begin),
##             (gt, "$qst.capture_conspirators_party_5", 0),
##             (party_detach, "$qst.capture_conspirators_party_5"),
##             (party_set_ai_behavior, "$qst.capture_conspirators_party_5", ai_bhvr_travel_to_point),
##             (party_set_flags, "$qst.capture_conspirators_party_5", pf_default_behavior, 0),
##             (call_script, "script_map_get_random_position_around_position_within_range", 15, 17),
##             (party_set_ai_target_position, "$qst.capture_conspirators_party_5", pos2),
##           (try_end),
##           (try_begin),
##             (gt, "$qst.capture_conspirators_party_6", 0),
##             (party_detach, "$qst.capture_conspirators_party_6"),
##             (party_set_ai_behavior, "$qst.capture_conspirators_party_6", ai_bhvr_travel_to_point),
##             (party_set_flags, "$qst.capture_conspirators_party_6", pf_default_behavior, 0),
##             (call_script, "script_map_get_random_position_around_position_within_range", 15, 17),
##             (party_set_ai_target_position, "$qst.capture_conspirators_party_6", pos2),
##           (try_end),
##           (try_begin),
##             (gt, "$qst.capture_conspirators_party_7", 0),
##             (party_detach, "$qst.capture_conspirators_party_7"),
##             (party_set_ai_behavior, "$qst.capture_conspirators_party_7", ai_bhvr_travel_to_point),
##             (party_set_flags, "$qst.capture_conspirators_party_7", pf_default_behavior, 0),
##             (call_script, "script_map_get_random_position_around_position_within_range", 15, 17),
##             (party_set_ai_target_position, "$qst.capture_conspirators_party_7", pos2),
##           (try_end),
##         (try_end),
##         (try_begin),
##           (get_party_ai_behavior, ":ai_behavior", "$qst.capture_conspirators_party_1"),
##           (eq, ":ai_behavior", ai_bhvr_travel_to_point),
##           (party_get_ai_target_position, pos2, "$qst.capture_conspirators_party_1"),
##           (party_get_position, pos1, "$qst.capture_conspirators_party_1"),
##           (get_distance_between_positions, ":distance", pos2, pos1),
##           (lt, ":distance", 200),
##           (call_script, "script_get_closest_walled_center_of_faction", "$qst.capture_conspirators_party_1", ":faction_no"),#Can fail
##           (ge, reg0, 0),
##           (party_set_ai_object, "$qst.capture_conspirators_party_1", reg0),
##           (party_set_ai_behavior, "$qst.capture_conspirators_party_1", ai_bhvr_travel_to_party),
##           (party_set_flags, "$qst.capture_conspirators_party_1", pf_default_behavior, 0),
##         (try_end),
##       (try_end),
##       (try_begin),
##         (gt, "$qst.capture_conspirators_party_2", 0),
##         (party_is_active, "$qst.capture_conspirators_party_2"),
##         (val_add, ":num_active_parties", 1),
##         (try_begin),
##           (party_is_in_any_town, "$qst.capture_conspirators_party_2"),
##           (try_begin),
##             (neg|party_is_in_town, "$qst.capture_conspirators_party_2", "$qst.capture_conspirators_party_1"),
##             (remove_party, "$qst.capture_conspirators_party_2"),
##           (else_try),
##             (get_party_ai_behavior, ":ai_behavior", "$qst.capture_conspirators_party_2"),
##             (neq, ":ai_behavior", ai_bhvr_hold),
##             (party_set_ai_behavior, "$qst.capture_conspirators_party_2", ai_bhvr_hold),
##             (party_attach_to_party, "$qst.capture_conspirators_party_2", "$qst.capture_conspirators_party_1"),
##             (party_set_flags, "$qst.capture_conspirators_party_2", pf_default_behavior, 0),
##           (try_end),
##         (try_end),
##         (try_begin),
##           (get_party_ai_behavior, ":ai_behavior", "$qst.capture_conspirators_party_2"),
##           (eq, ":ai_behavior", ai_bhvr_travel_to_point),
##           (party_get_ai_target_position, pos2, "$qst.capture_conspirators_party_2"),
##           (party_get_position, pos1, "$qst.capture_conspirators_party_2"),
##           (get_distance_between_positions, ":distance", pos2, pos1),
##           (lt, ":distance", 200),
##           (call_script, "script_get_closest_walled_center_of_faction", "$qst.capture_conspirators_party_2", ":faction_no"),#Can fail
##           (ge, reg0, 0),
##           (party_set_ai_object, "$qst.capture_conspirators_party_2", reg0),
##           (party_set_ai_behavior, "$qst.capture_conspirators_party_2", ai_bhvr_travel_to_party),
##           (party_set_flags, "$qst.capture_conspirators_party_2", pf_default_behavior, 0),
##         (try_end),
##       (try_end),
##       (try_begin),
##         (gt, "$qst.capture_conspirators_party_3", 0),
##         (party_is_active, "$qst.capture_conspirators_party_3"),
##         (val_add, ":num_active_parties", 1),
##         (try_begin),
##           (party_is_in_any_town, "$qst.capture_conspirators_party_3"),
##           (try_begin),
##             (neg|party_is_in_town, "$qst.capture_conspirators_party_3", "$qst.capture_conspirators_party_1"),
##             (remove_party, "$qst.capture_conspirators_party_3"),
##           (else_try),
##             (get_party_ai_behavior, ":ai_behavior", "$qst.capture_conspirators_party_3"),
##             (neq, ":ai_behavior", ai_bhvr_hold),
##             (party_set_ai_behavior, "$qst.capture_conspirators_party_3", ai_bhvr_hold),
##             (party_attach_to_party, "$qst.capture_conspirators_party_3", "$qst.capture_conspirators_party_1"),
##             (party_set_flags, "$qst.capture_conspirators_party_3", pf_default_behavior, 0),
##           (try_end),
##         (try_end),
##         (try_begin),
##           (get_party_ai_behavior, ":ai_behavior", "$qst.capture_conspirators_party_3"),
##           (eq, ":ai_behavior", ai_bhvr_travel_to_point),
##           (party_get_ai_target_position, pos2, "$qst.capture_conspirators_party_3"),
##           (party_get_position, pos1, "$qst.capture_conspirators_party_3"),
##           (get_distance_between_positions, ":distance", pos2, pos1),
##           (lt, ":distance", 200),
##           (call_script, "script_get_closest_walled_center_of_faction", "$qst.capture_conspirators_party_3", ":faction_no"),#Can fail
##           (ge, reg0, 0),
##           (party_set_ai_object, "$qst.capture_conspirators_party_3", reg0),
##           (party_set_ai_behavior, "$qst.capture_conspirators_party_3", ai_bhvr_travel_to_party),
##           (party_set_flags, "$qst.capture_conspirators_party_3", pf_default_behavior, 0),
##         (try_end),
##       (try_end),
##       (try_begin),
##         (gt, "$qst.capture_conspirators_party_4", 0),
##         (party_is_active, "$qst.capture_conspirators_party_4"),
##         (val_add, ":num_active_parties", 1),
##         (try_begin),
##           (party_is_in_any_town, "$qst.capture_conspirators_party_4"),
##           (try_begin),
##             (neg|party_is_in_town, "$qst.capture_conspirators_party_4", "$qst.capture_conspirators_party_1"),
##             (remove_party, "$qst.capture_conspirators_party_4"),
##           (else_try),
##             (get_party_ai_behavior, ":ai_behavior", "$qst.capture_conspirators_party_4"),
##             (neq, ":ai_behavior", ai_bhvr_hold),
##             (party_set_ai_behavior, "$qst.capture_conspirators_party_4", ai_bhvr_hold),
##             (party_set_flags, "$qst.capture_conspirators_party_4", pf_default_behavior, 0),
##             (party_attach_to_party, "$qst.capture_conspirators_party_4", "$qst.capture_conspirators_party_1"),
##           (try_end),
##         (try_end),
##         (try_begin),
##           (get_party_ai_behavior, ":ai_behavior", "$qst.capture_conspirators_party_4"),
##           (eq, ":ai_behavior", ai_bhvr_travel_to_point),
##           (party_get_ai_target_position, pos2, "$qst.capture_conspirators_party_4"),
##           (party_get_position, pos1, "$qst.capture_conspirators_party_4"),
##           (get_distance_between_positions, ":distance", pos2, pos1),
##           (lt, ":distance", 200),
##           (call_script, "script_get_closest_walled_center_of_faction", "$qst.capture_conspirators_party_4", ":faction_no"),#Can fail
##           (ge, reg0, 0),
##           (party_set_ai_object, "$qst.capture_conspirators_party_4", reg0),
##           (party_set_ai_behavior, "$qst.capture_conspirators_party_4", ai_bhvr_travel_to_party),
##           (party_set_flags, "$qst.capture_conspirators_party_4", pf_default_behavior, 0),
##         (try_end),
##       (try_end),
##       (try_begin),
##         (gt, "$qst.capture_conspirators_party_5", 0),
##         (party_is_active, "$qst.capture_conspirators_party_5"),
##         (val_add, ":num_active_parties", 1),
##         (try_begin),
##           (party_is_in_any_town, "$qst.capture_conspirators_party_5"),
##           (try_begin),
##             (neg|party_is_in_town, "$qst.capture_conspirators_party_5", "$qst.capture_conspirators_party_1"),
##             (remove_party, "$qst.capture_conspirators_party_5"),
##           (else_try),
##             (get_party_ai_behavior, ":ai_behavior", "$qst.capture_conspirators_party_5"),
##             (neq, ":ai_behavior", ai_bhvr_hold),
##             (party_set_ai_behavior, "$qst.capture_conspirators_party_5", ai_bhvr_hold),
##             (party_set_flags, "$qst.capture_conspirators_party_5", pf_default_behavior, 0),
##             (party_attach_to_party, "$qst.capture_conspirators_party_5", "$qst.capture_conspirators_party_1"),
##           (try_end),
##         (try_end),
##         (try_begin),
##           (get_party_ai_behavior, ":ai_behavior", "$qst.capture_conspirators_party_5"),
##           (eq, ":ai_behavior", ai_bhvr_travel_to_point),
##           (party_get_ai_target_position, pos2, "$qst.capture_conspirators_party_5"),
##           (party_get_position, pos1, "$qst.capture_conspirators_party_5"),
##           (get_distance_between_positions, ":distance", pos2, pos1),
##           (lt, ":distance", 200),
##           (call_script, "script_get_closest_walled_center_of_faction", "$qst.capture_conspirators_party_5", ":faction_no"),#Can fail
##           (ge, reg0, 0),
##           (party_set_ai_object, "$qst.capture_conspirators_party_5", reg0),
##           (party_set_ai_behavior, "$qst.capture_conspirators_party_5", ai_bhvr_travel_to_party),
##           (party_set_flags, "$qst.capture_conspirators_party_5", pf_default_behavior, 0),
##         (try_end),
##       (try_end),
##       (try_begin),
##         (gt, "$qst.capture_conspirators_party_6", 0),
##         (party_is_active, "$qst.capture_conspirators_party_6"),
##         (val_add, ":num_active_parties", 1),
##         (try_begin),
##           (party_is_in_any_town, "$qst.capture_conspirators_party_6"),
##           (try_begin),
##             (neg|party_is_in_town, "$qst.capture_conspirators_party_6", "$qst.capture_conspirators_party_1"),
##             (remove_party, "$qst.capture_conspirators_party_6"),
##           (else_try),
##             (get_party_ai_behavior, ":ai_behavior", "$qst.capture_conspirators_party_6"),
##             (neq, ":ai_behavior", ai_bhvr_hold),
##             (party_set_ai_behavior, "$qst.capture_conspirators_party_6", ai_bhvr_hold),
##             (party_set_flags, "$qst.capture_conspirators_party_6", pf_default_behavior, 0),
##             (party_attach_to_party, "$qst.capture_conspirators_party_6", "$qst.capture_conspirators_party_1"),
##           (try_end),
##         (try_end),
##         (try_begin),
##           (get_party_ai_behavior, ":ai_behavior", "$qst.capture_conspirators_party_6"),
##           (eq, ":ai_behavior", ai_bhvr_travel_to_point),
##           (party_get_ai_target_position, pos2, "$qst.capture_conspirators_party_6"),
##           (party_get_position, pos1, "$qst.capture_conspirators_party_6"),
##           (get_distance_between_positions, ":distance", pos2, pos1),
##           (lt, ":distance", 200),
##           (call_script, "script_get_closest_walled_center_of_faction", "$qst.capture_conspirators_party_6", ":faction_no"),#Can fail
##           (ge, reg0, 0),
##           (party_set_ai_object, "$qst.capture_conspirators_party_6", reg0),
##           (party_set_ai_behavior, "$qst.capture_conspirators_party_6", ai_bhvr_travel_to_party),
##           (party_set_flags, "$qst.capture_conspirators_party_6", pf_default_behavior, 0),
##         (try_end),
##       (try_end),
##       (try_begin),
##         (gt, "$qst.capture_conspirators_party_7", 0),
##         (party_is_active, "$qst.capture_conspirators_party_7"),
##         (val_add, ":num_active_parties", 1),
##         (try_begin),
##           (party_is_in_any_town, "$qst.capture_conspirators_party_7"),
##           (try_begin),
##             (neg|party_is_in_town, "$qst.capture_conspirators_party_7", "$qst.capture_conspirators_party_1"),
##             (remove_party, "$qst.capture_conspirators_party_7"),
##           (else_try),
##             (get_party_ai_behavior, ":ai_behavior", "$qst.capture_conspirators_party_7"),
##             (neq, ":ai_behavior", ai_bhvr_hold),
##             (party_set_ai_behavior, "$qst.capture_conspirators_party_7", ai_bhvr_hold),
##             (party_set_flags, "$qst.capture_conspirators_party_7", pf_default_behavior, 0),
##             (party_attach_to_party, "$qst.capture_conspirators_party_7", "$qst.capture_conspirators_party_1"),
##           (try_end),
##         (try_end),
##         (try_begin),
##           (get_party_ai_behavior, ":ai_behavior", "$qst.capture_conspirators_party_7"),
##           (eq, ":ai_behavior", ai_bhvr_travel_to_point),
##           (party_get_ai_target_position, pos2, "$qst.capture_conspirators_party_7"),
##           (party_get_position, pos1, "$qst.capture_conspirators_party_7"),
##           (get_distance_between_positions, ":distance", pos2, pos1),
##           (lt, ":distance", 200),
##           (call_script, "script_get_closest_walled_center_of_faction", "$qst.capture_conspirators_party_7", ":faction_no"),#Can fail
##           (ge, reg0, 0),
##           (party_set_ai_object, "$qst.capture_conspirators_party_7", reg0),
##           (party_set_ai_behavior, "$qst.capture_conspirators_party_7", ai_bhvr_travel_to_party),
##           (party_set_flags, "$qst.capture_conspirators_party_7", pf_default_behavior, 0),
##         (try_end),
##       (try_end),
##
...
##       (try_begin),
##         (store_div, ":limit", "$qst.capture_conspirators_num_troops_to_capture", 2),
