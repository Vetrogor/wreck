...
pf_dont_send_to_clients      = 0x00008000  # WSE2 multiplayer campaign, for parties used only for calculating on server-side
...
aggressiveness_15 = 0x00F0 # The highest value of aggresiveness will not guarantee party to attack enemy.
