...
itp_type_thrown          = 0x000000000000000a  # 10
itp_type_goods           = 0x000000000000000b  # 11
itp_type_head_armor      = 0x000000000000000c  # 12
itp_type_body_armor      = 0x000000000000000d  # 13
itp_type_foot_armor      = 0x000000000000000e  # 14
itp_type_hand_armor      = 0x000000000000000f  # 15
itp_type_pistol          = 0x0000000000000010  # 16
itp_type_musket          = 0x0000000000000011  # 17
itp_type_bullets         = 0x0000000000000012  # 18
itp_type_animal          = 0x0000000000000013  # 19
itp_type_book            = 0x0000000000000014  # 20
itp_type_lance           = 0x0000000000000015  # 21 Ascension: for auto equipment, needs to script
...
itp_covers_hands             = 0x1000000000000000 # WSE: remove hands mesh (works on body armor items)
...
itc_parry_twohanded = itc_parry_two_handed = itcf_force_64_bits|itcf_parry_forward_twohanded|itcf_parry_up_twohanded|itcf_parry_right_twohanded|itcf_parry_left_twohanded
...
itc_parry_twohanded = itcf_force_64_bits|itcf_parry_forward_twohanded|itcf_parry_up_twohanded|itcf_parry_right_twohanded|itcf_parry_left_twohanded

itc_parry_polearm = itcf_parry_forward_polearm|itcf_parry_up_polearm|itcf_parry_right_polearm|itcf_parry_left_polearm

itc_axe = itc_parry_onehanded|itcf_overswing_onehanded|itcf_slashright_onehanded|itcf_slashleft_onehanded|itcf_horseback_slashright_onehanded|itcf_horseback_slashleft_onehanded

itc_sword = itc_axe|itcf_thrust_onehanded

itc_twohander = itc_parry_twohanded|itcf_slashright_twohanded|itcf_slashleft_twohanded|itcf_overswing_twohanded|itcf_horseback_slashright_onehanded|itcf_horseback_slashleft_onehanded

itc_greatsword = itc_twohander|itcf_thrust_twohanded|itcf_thrust_onehanded_lance|itcf_overswing_onehanded

itc_bastard_sword = itc_bastardsword =itc_greatsword|itcf_thrust_onehanded|itcf_slashright_onehanded|itcf_slashleft_onehanded|itcf_horseback_slashright_onehanded|itcf_horseback_slashleft_onehanded

itc_bastard_axe = itc_twohander|itcf_overswing_onehanded|itcf_slashright_onehanded|itcf_slashleft_onehanded|itcf_horseback_slashright_onehanded|itcf_horseback_slashleft_onehanded

itc_glaive = itc_parry_polearm|itcf_overswing_polearm|itcf_thrust_polearm|itcf_slashright_polearm|itcf_slashleft_polearm|itcf_thrust_onehanded_lance|itcf_horseback_slashright_onehanded|itcf_horseback_slashleft_onehanded|itcf_horseback_slash_polearm|itcf_overswing_onehanded|itcf_slashright_onehanded|itcf_slashleft_onehanded

itc_spear = itc_parry_polearm|itcf_overswing_polearm|itcf_thrust_polearm|itcf_slashright_polearm|itcf_slashleft_polearm|itcf_overswing_onehanded|itcf_slashright_onehanded|itcf_slashleft_onehanded|itcf_thrust_onehanded_lance|itcf_horseback_slashright_onehanded|itcf_horseback_slashleft_onehanded

itc_scythe = itc_parry_polearm|itcf_overswing_polearm|itcf_slashright_polearm|itcf_slashleft_polearm|itcf_horseback_slash_polearm|itcf_horseback_slashright_onehanded|itcf_horseback_slashleft_onehanded|itcf_overswing_onehanded|itcf_slashright_onehanded|itcf_slashleft_onehanded
