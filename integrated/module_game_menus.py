...
##     (troop_raise_skill, "trp_player", skl.shield, -1000),
##     (troop_raise_skill, "trp_player", skl.athletics, -1000),
##     (troop_raise_skill, "trp_player", skl.riding, -1000),
##     (troop_raise_skill, "trp_player", skl.power_strike, -1000),
##     (troop_raise_skill, "trp_player", skl.power_throw, -1000),
##     (troop_raise_skill, "trp_player", skl.weapon_master, -1000),
##     (troop_raise_skill, "trp_player", skl.horse_archery, -1000),
##     (troop_raise_skill, "trp_player", skl.ironflesh, -1000),
...
##       (troop_raise_skill, "$g_player_troop", skl.athletics, 2),
##       (troop_raise_skill, "$g_player_troop", skl.riding, 3),
##       (troop_raise_skill, "$g_player_troop", skl.power_strike, 4),
##       (troop_raise_skill, "$g_player_troop", skl.power_draw, 5),
##       (troop_raise_skill, "$g_player_troop", skl.weapon_master, 4),    
##       (troop_raise_skill, "$g_player_troop", skl.ironflesh, 6),
...
##             (troop_raise_attribute, "trp_player",ca_agility,1),
##             (troop_raise_attribute, "trp_player",ca_strength,1),
##             (troop_raise_skill, "trp_player",skl.power_strike,2),
##             (troop_raise_proficiency, "trp_player",0,30),
##             (troop_raise_proficiency, "trp_player",1,20),
##           (else_try),
##             (eq, "$starting_skill", 2),
##             (troop_raise_attribute, "trp_player",ca_strength,2),
##             (troop_raise_skill, "trp_player",skl.power_draw,2),
...
##        (troop_add_item, "trp_player","itm_red_gambeson",imod.plain),
##        (troop_add_item, "trp_player","itm_sword",imod.plain),
##        (troop_add_item, "trp_player","itm_dagger",imod.balanced),
##        (troop_add_item, "trp_player","itm_woolen_hose",0),
##        (troop_add_item, "trp_player","itm_dried_meat",0),
##        (troop_add_item, "trp_player","itm_saddle_horse",imod.plain),
...
##        (troop_add_item, "trp_player","itm_dress",imod.sturdy),
##        (troop_add_item, "trp_player","itm_dagger",imod.watered_steel),
##        (troop_add_item, "trp_player","itm_woolen_hose",0),
...
##        (troop_add_item, "trp_player","itm_skullcap",imod.rusty),
##        (troop_add_item, "trp_player","itm_spear",0),
##        (troop_add_item, "trp_player","itm_arming_sword",imod.chipped),
##        (troop_add_item, "trp_player","itm_hunting_crossbow",0),
##        (troop_add_item, "trp_player","itm_hunter_boots",0),
##        (troop_add_item, "trp_player","itm_leather_gloves",imod.ragged),
##        (troop_add_item, "trp_player","itm_bolts",0),
##        (troop_add_item, "trp_player","itm_smoked_fish",0),
...
##        (troop_add_item, "trp_player","itm_short_bow",imod.bent),
...
##        (troop_add_item, "trp_player","itm_javelin",imod.bent),
##        (troop_add_item, "trp_player","itm_sword_khergit_1",imod.rusty),
...
##        (troop_add_item, "trp_player","itm_steppe_horse",0),
      ...
      (else_try),
        ...
        (troop_add_item, "trp_player","itm_tab_shield_small_round_a",imod.battered),
##        (troop_add_item, "trp_player","itm_javelin",imod.bent),
##        (troop_add_item, "trp_player","itm_sickle",imod.plain),
##        (troop_add_item, "trp_player","itm_nomad_armor",0),
##        (troop_add_item, "trp_player","itm_hide_boots",0),
##        (troop_add_item, "trp_player","itm_steppe_horse",0),
...
##        (troop_add_item, "trp_player","itm_cudgel",imod.plain),
##        (troop_add_item, "trp_player","itm_dagger",imod.rusty),
##        (troop_add_item, "trp_player","itm_shirt",imod.tattered),
##        (troop_add_item, "trp_player","itm_black_hood",imod.tattered),
##        (troop_add_item, "trp_player","itm_wrapping_boots",imod.ragged),
...
##        (troop_raise_skill, "trp_player",skl.wound_treatment,1),
##        (troop_raise_skill, "trp_player",skl.leadership,1),
##        (troop_raise_skill, "trp_player",skl.prisoner_management,1),
...
##        (troop_raise_attribute, "trp_player",ca_charisma,1),
##        (troop_raise_skill, "trp_player",skl.leadership,1),
##        (troop_raise_skill, "trp_player",skl.athletics,1),
##        (troop_raise_skill, "trp_player",skl.riding,1),
...
##        (troop_raise_attribute, "trp_player",ca_strength,1),
##        (troop_raise_skill, "trp_player",skl.power_strike,1),
##        (troop_raise_skill, "trp_player",skl.shield,1),
##        (troop_add_gold, "trp_player", 10),
##        (try_begin),
...
##        (troop_add_item, "trp_player","itm_wooden_shield",imod.battered),
##        (troop_raise_proficiency, "trp_player",0,10),
##        (troop_raise_proficiency, "trp_player",4,10),
##    (else_try),
...
##        (try_end),
##        (troop_add_item, "trp_player","itm_khergit_guard_helmet",imod.crude),
##        (troop_add_item, "trp_player","itm_mail_chausses",imod.crude),
##        (troop_add_item, "trp_player","itm_sword_khergit_1",imod.plain),
##        (troop_add_gold, "trp_player", 20),
...
##        (troop_raise_skill, "trp_player",skl.surgery,1),
##        (troop_add_item, "trp_player","itm_leather_gloves",imod.ragged),
##        (troop_add_item, "trp_player","itm_quarter_staff",imod.heavy),
  ...
  (
    ...
    [
        ...
        (else_try),                 
          ...
          #p.total_enemy_casualties deki yarali askerler p.temp_party'e prisoner olarak eklenecek.
 ...
 In addition to honour, fame and glory, you earn a prize of {reg9} denars. {s8}",
  ...
  (
    ...
    [
        ...
        (call_script, "script_sort_tournament_participant_troops"),#Moving trp.player to the top of the list
        (call_script, "script_get_num_tournament_participants"),
    ...
    [
      ...
      ("tournament_join_next_fight", [], "Fight in the next round.",
       [
           ...
           (troop_set_slot, "trp_tournament_participants", 0, -1),#Removing trp.player from the list
 ...
 You get up and try to look for any other survivors from your party.",
  ...
  (
    ...
    [
      ("continue",[],"Continue...",
       [
	     # Explanation of removing below code : heros are already being removed with 50% (was 75%, I decreased it) probability in mnu.total_defeat, why here there is additionally 30% removing of heros?
		 ...
		 # "mnu_total_defeat" and inside the "mnu_total_defeat" there is script.party_remove_all_companions which removes 50% (was 75%, I decreased it) of compainons from player party.		
